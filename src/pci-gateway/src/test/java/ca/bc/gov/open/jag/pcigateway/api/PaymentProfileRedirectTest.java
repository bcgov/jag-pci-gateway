...
public class PaymentProfileRedirectTest {
    ...
    public void withValidParamsShouldReturnValidUrl() throws MissingServletRequestParameterException {
        ...
        RedirectView result = sut.profileRedirect(mockHttpServletRequest);

        Assertions.assertEquals("http://localhost:8080/scripts/paymentProfile/webform.asp?merchant_id=merchantId&hashValue=E2EEA71D02D92AD968A9A63A44862413", result.getUrl());
    ...
    public void withValidParamsAndMoreShouldReturnValidUrl() throws MissingServletRequestParameterException {
        ...
        Assertions.assertEquals("http://localhost:8080/scripts/paymentProfile/webform.asp?merchant_id=merchantId&hashValue=E2EEA71D02D92AD968A9A63A44862413&otherparams=otherparams", result.getUrl());
    ...
    public void testVariationOfMerchantId() throws MissingServletRequestParameterException {
        ...
        for (String key :
            ...
            mockHttpServletRequest.setParameter("hashValue", "810AB4ECB7C361D2FCEEEABD2F7994EA");
            RedirectView actual = sut.profileRedirect(mockHttpServletRequest);
            String expected = MessageFormat.format(
                    "http://localhost:8080/scripts/paymentProfile/webform.asp?{0}=merchantId&hashValue=E2EEA71D02D92AD968A9A63A44862413"
                    , key);
    ...
    public void withoutHashKeyShouldReturn400() throws MissingServletRequestParameterException {
        MockHttpServletRequest mockHttpServletRequest = new MockHttpServletRequest();
        mockHttpServletRequest.setParameter("merchant_id", MERCHANT_ID);
        Assertions.assertThrows(MissingServletRequestParameterException.class, () ->  sut.profileRedirect(mockHttpServletRequest));
    }
